...
def about_product(prod):
    ...
    Cached for the lifetime of the process; collection metadata only
    changes when a new product version is published.
...
def latest_version(product):
    ...
    Cached per process; see :func:`about_product`.
